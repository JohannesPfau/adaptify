...
public class SpawnableSolar : Spawnable {

    public SpawnableSolar(int locX, int locY, int locZ, ColoredCubesVolume ccv, GameObject templatePrefab)
    {
        x = locX;
        y = locY;
        z = locZ;
    ...
    override public void spawn()
    {
        if (y == 0)
        {
            Debug.Log("Warning: Trying to spawn Solar on water.");
            //return;
        }
